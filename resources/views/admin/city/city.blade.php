...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
					...
					@endif
										...
										<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
											...
											<!--begin::Add product-->
											<a href="{{ url('admin/add-edit-city') }}" class="btn btn-primary">Add City</a>
											<!--end::Add product-->
										</div>
										<!--end::Card toolbar-->
									</div>
													...
													<td class="text-end">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															...
															<div class="menu-item px-3">
																<a href="{{ url('admin/add-edit-city/'.$page['id']) }}" class="menu-link px-3">Edit</a>
															</div>
															<!--end::Menu item-->
															<!--begin::Menu item-->
															<div class="menu-item px-3">@csrf
															<a href="{{ url('admin/delete-city/'.$page['id']) }}" class="menu-link px-3" onclick="return confirm('Are you sure you want to delete this data?')">Delete</a>
															</div>
															<!--end::Menu item-->
														</div>
														<!--end::Menu-->
