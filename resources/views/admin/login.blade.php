...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../../">
		<title>Student Admission System in Taiwan University</title>
		<meta charset="utf-8" />
	...
	<body id="kt_body" class="bg-body">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url('admin/media/illustrations/sketchy-1/14.png')">
				<!--begin::Content-->
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					<!--begin::Logo-->
						<img alt="Logo" src="{{ url('admin/media/logos/sastulogo.svg') }}" class="h-65px" />
					<!--end::Logo-->
					<!--begin::Wrapper-->
					...
					@endif
						<form class="form w-100" id="kt_sign_in_form" action="{{ url('admin/login') }}" method="post">@csrf
							<div class="text-center mb-10">
								<!--begin::Title-->
								<h1 class="text-dark mb-3">Sign In to Database</h1>
								<!--end::Title-->
								<!--begin::Link-->
							...
							<div class="fv-row mb-10">
								...
								<!--end::Label-->
								<!--begin::Input-->
								<input class="form-control form-control-lg form-control-solid" type="email" name="email" placeholder="email"/>
								<!--end::Input-->
							</div>
							<!--end::Input group-->
							<!--begin::Input group-->
		...
		<!--end::Main-->
		<!--begin::Javascript-->
		<script>var hostUrl = "{{ url('admin/') }}";</script>
