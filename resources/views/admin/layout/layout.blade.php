...
<html lang="en">
	...
	@extends('admin.layout.footer')
		...
		<script src="{{ url('admin/js/widgets.bundle.js') }}"></script>
		<script src="{{ url('admin/js/custom/widgets.js') }}"></script>
		<script src="{{ url('admin/js/custom/apps/chat/chat.js') }}"></script>
		<script src="{{ url('admin/js/custom/utilities/modals/upgrade-plan.js') }}"></script>
		<script src="{{ url('admin/js/custom/utilities/modals/create-app.js') }}"></script>
		<script src="{{ url('admin/js/custom/utilities/modals/users-search.js') }}"></script>
